...
*/
$config['tables']['users']           = 'people';
$config['tables']['groups']          = 'people';
$config['tables']['users_groups']    = 'people';
$config['tables']['login_attempts']  = 'people';
 ...
 */
$config['site_title']                 = "PFS Sessiontracker";       // Site Title, example.com
$config['admin_email']                = "no-reply@campaigncodex.com";		// Admin Email, admin@example.com
